...
- Maximized transparent overlay window.
...
- `Esc` to close.
- Hotkeys: `1/F1` Pen, `2/F2` Eraser, `3/F3` Mouse.
...
- In Mouse mode, use hotkeys `1/F1` (Pen) or `2/F2` (Eraser) to return instantly if passthrough prevents clicking the toolbar.
