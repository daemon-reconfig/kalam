...
impl OpenPenApp {
    fn set_tool(&mut self, tool: Tool, ctx: &egui::Context) {
        self.tool = tool;
            ...
            .show(ctx, |ui| {
                egui::Frame::window(ui.style())
                    ...
                    .show(ui, |ui| {
                        ...
                        ui.small("Hotkeys: 1/F1 Pen · 2/F2 Eraser · 3/F3 Mouse · Esc Quit");
                    });
            });
    }
